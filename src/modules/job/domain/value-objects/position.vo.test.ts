...
describe("Position vo test" , ()=>{

    it("Return type should be Result type",()=>{
        const data = " ";
        const result = Position.create(data);

        expectTypeOf(result).toEqualTypeOf<Result<Position,ValidationError>>()
    })
